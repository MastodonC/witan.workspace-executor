...
(deftest redis-loop-test
  (testing "linear flow with loop - single task"
    ;; digraph G {
    ;; "in" -> "inc"
    ;; "inc" -> "dbl"
    ;; "inc" -> "inc"
  ...
  (testing "linear flow with loop - spans multiple tasks"
    ;; digraph G {
    ;; "in" -> "inc"
    ;; "inc" -> "dbl"
    ;; "dbl" -> "div"
          ...
          base-job {:workflow [[:in :write-state]
                    ...
                    :catalog [{:onyx/name :inc
                              ...
                              {:onyx/name :dbl
                               ...
                               :onyx/batch-timeout batch-timeout}
                              {:onyx/name :div
                               :onyx/fn   :onyx.plugin.redis-loop-job-test/my-div
                               :onyx/type :function
                               :my-div/value 2
                               :onyx/params [:my-div/value]
                               :onyx/batch-size batch-size
                               :onyx/batch-timeout batch-timeout}]
